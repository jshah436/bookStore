...
function Banner() {
  ...
  return (
    <>
          ...
          <div className='order-2 w-full md:w-1/2 md:mt-32 '>
    ...
    <path
     ...
     <input type="text" className="grow outline-none" placeholder="Enter your email to login" />
          ...
          <button className="px-3 py-2 bg-pink-500 duration-200 rounded-md border text-white mt-6 hover:bg-pink-700 ">Subscribe</button>
          </div>
          <div className='order-1 md:order-2 w-full md:w-1/2'>
            <img className='w-92 h-92' src={banner}/>
          </div>
          </div>
    </>
